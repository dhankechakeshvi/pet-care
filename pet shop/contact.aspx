<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="pet_shop.contact" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                     <%--<a href="logiiin.aspx" class="nav-item nav-link">Login</a>--%>
                      <div><a href="Reg.aspx" class="nav-item nav-link ">Registration</a></div>
    ...
    <div class="container-fluid pt-5">
        <div class="d-flex flex-column text-center mb-5 pt-5">
            ...
            <h1 class="display-4 m-0">Contact For <span class="textAny Query"></span></h1>
        </div>
                ...
                <div class="contact-form">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            ...
                            <asp:TextBox ID="name" runat="server" class="form-control p-4"  placeholder="Your Name"></asp:TextBox>
                        ...
                        <div class="control-group">
                           <%-- <input type="email" class="form-control p-4" id="email" placeholder="Your Email" required="required" data-validation-required-message="Please enter your email" />--%>
                            <asp:TextBox ID="email" runat="server" class="form-control p-4" placeholder="Your Email"></asp:TextBox>
                         <%--   <p class="help-block text-danger"></p>--%>
                        </div>
                        <br />
                        ...
                        <div class="control-group">
                           <%-- <input type="text" class="form-control p-4" id="subject" placeholder="Subject" required="required" data-validation-required-message="Please enter a subject" />--%>
                            <asp:TextBox ID="subject" runat="server" class="form-control p-4" placeholder="Subject"></asp:TextBox>
                           <%-- <p class="help-block text-danger"></p>--%>
                        </div>
                    <br />
                        <div class="control-group">
                            <%--<textarea class="form-control p-4" rows="6" id="message" placeholder="Message" required="required" data-validation-required-message="Please enter your message"></textarea>--%>
                            <asp:TextBox ID="message" runat="server"  class="form-control p-4" rows="6" placeholder="Message"></asp:TextBox>
                           <%-- <p class="help-block text-danger"></p>--%>
                        </div>
                       <br />
                        <div>
                           <%-- <button class="btn btn-primary py-3 px-5" type="submit" id="sendMessageButton">Send Messagend Message</button>--%>
                            <asp:Button ID="Button1" runat="server" class="btn btn-primary py-3 px-5" Text="Submit" OnClick="Button1_Click" />
                        </div>
