<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="logiiin.aspx.cs" Inherits="pet_shop.logiiin" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <table class="table table-borderless">
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Text="User Name"></asp:Label>
                   <asp:TextBox ID="cname" runat="server" class="form-control p-4"></asp:TextBox>
            </td>
        ...
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" Text="Password"></asp:Label>
                  <asp:TextBox ID="cpass" runat="server" class="form-control p-4" TextMode="Password"></asp:TextBox>
            </td>
        ...
        <%-- <tr>
            <td>
                <asp:Label ID="Label3" runat="server" Text="Confirm Password"></asp:Label>
                  <asp:TextBox ID="TextBox3" runat="server" class="form-control p-4" TextMode="Password"></asp:TextBox>
            </td>
          
        </tr>--%>
        <tr>
            <td colspan="2" class="text-center">
                <asp:Button ID="Btn" class="btn btn-primary py-3 px-5" runat="server" Text="Login" OnClick="Btn_Click" />
            </td>
        </tr>
        <tr>
            <td colspan="2" class="text-center">
                <asp:LinkButton ID="LinkButton1" href="Reg.aspx" runat="server">Register</asp:LinkButton>
            </td>
        </tr>
    </table>
</form>
