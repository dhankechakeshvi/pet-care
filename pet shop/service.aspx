<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="service.aspx.cs" Inherits="pet_shop.service" %>
...
<head>
    ...
    <%--<a href="service.aspx">service.aspx</a>--%>
            ...
            <div class="row pb-3">
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        ...
                        <p>A home away from home! Our pet boarding services provide a safe, comfortable, and caring environment, ensuring your furry friend is happy and well cared for while you're away."</p>
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        ...
                        <p>"From basic obedience to advanced skills, our professional pet training helps your furry friend learn good behavior in a fun and positive way!"</p>
                        <!--<a class="text-uppercase font-weight-bold" href="">Read More</a>-->
                        <br />
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        ...
                        <p>"Keeping tails wagging and paws moving—our pet exercise services ensure your furry friend stays active, healthy, and happy!"</p>
                        <!--<a class="text-uppercase font-weight-bold" href="">Read More</a>-->
                        <br />
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        ...
                        <p>"Compassionate care for your pet’s health—our professional treatment services ensure they receive the attention and medical support they need."</p>
                        <!--<a class="text-uppercase font-weight-bold" href="">Read More</a>-->
                    </div>
                </div>
            </div>
