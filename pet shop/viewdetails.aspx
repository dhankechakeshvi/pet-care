<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="viewdetails.aspx.cs" Inherits="pet_shop.viewdetails" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal">
        <ItemTemplate>
            <asp:Image ID="Image1" runat="server" Height="300px" Width="380px" ImageUrl='<%# "Admin/"+Eval("Image") %>' />
            <br />
            Pet Id:
            ...
            <asp:Label ID="Label3" runat="server" Text='<%# Eval("P_name") %>'></asp:Label>
             <br />
            Pet Price:
              <asp:Label ID="Label5" runat="server" Text='<%# Eval("Price_p") %>'></asp:Label>
             <br />
            Description:
