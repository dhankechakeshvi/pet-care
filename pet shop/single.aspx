<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="single.aspx.cs" Inherits="pet_shop.single" %>
    ...
    <div class="container py-5">
        <div class="row pt-5">
                ...
                <div style="padding: 30px; background: #f6f6f6;">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="TextBox2" runat="server"  class="form-control" OnTextChanged="TextBox2_TextChanged"></asp:TextBox>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           <%-- <label for="message">Message *</label>
                            ...
                            <asp:TextBox ID="TextBox4" runat="server" cols="30" rows="5" class="form-control"></asp:TextBox>
                        </div>
                        <div class="form-group mb-0">
                           <%-- <input type="submit" value="Leave Comment" class="btn btn-primary px-3">--%>
                            <asp:Button ID="Button1" runat="server"  class="btn btn-primary px-3" Text="Leave Comment" OnClick="Button1_Click" />
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="col-lg-4 mt-5 mt-lg-0">
                ...
                <div class="mb-5">
                    <h3 class="mb-4">CategoriesCategories</h3>
                    <ul class="list-group">
