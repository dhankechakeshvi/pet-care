...
namespace pet_shop
{
    public partial class about : System.Web.UI.Page
    {
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)//view details
        {

        }

        protected void LinkButton2_Click(object sender, EventArgs e)//addto cart
        {
        ...
        void display()
        {
            da = new SqlDataAdapter("select * from Cat_tbl", cs.startcon());
            ds = new DataSet();
            da.Fill(ds);
        ...
        protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)//datalist
        {
