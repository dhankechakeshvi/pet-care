<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="price.aspx.cs" Inherits="pet_shop.price" %>
            ...
            <div class="col-lg-8 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    ...
                    <div class="d-inline-flex flex-column text-center px-3 border-right">
                        <h6>Email Us</h6>
                        <p class="m-0">psanyaja55@rku.ac.in</p>
                    </div>
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                  ...
                  <%--  <a href="service.aspx" class="nav-item nav-link">Service</a>--%>
                    <a href="price.aspx" class="nav-item nav-link active">Price</a>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card border-0">
                       ...
                       <%--     <a href="" class="btn btn-primary btn-block p-3" style="border-radius: 0;">Book Now</a>--%>
                            <asp:Button ID="Button1" runat="server"  class="btn btn-primary btn-block p-3" style="border-radius: 0;" Text="Book Now" />
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
                    <div class="card border-0">
                        ...
                        <div class="card-footer border-0 p-0">
                          <%--  <a href="" class="btn btn-secondary btn-block p-3" style="border-radius: 0;">Book Now</a>--%>
                            <asp:Button ID="Button3" runat="server" class="btn btn-secondary btn-block p-3" style="border-radius: 0;" Text="Book Now" />
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
                    <div class="card border-0">
                        ...
                        <div class="card-footer border-0 p-0">
                            <%--<a href="" class="btn btn-secondary btn-block p-3" style="border-radius: 0;">Book Now</a>--%>
                            <asp:Button ID="Button4" runat="server" class="btn btn-secondary btn-block p-3" style="border-radius: 0;" Text="Book Now" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 py-5 py-lg-0 px-3 px-lg-5">
                    <h4 class="text-secondary mb-3">Going for a vacation? vacation?</h4>
