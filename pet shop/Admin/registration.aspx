<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="registration.aspx.cs" Inherits="pet_shop.Admin.registration" %>
                ...
                <div class="navbar-nav mr-auto py-0">
                   ...
                   <%-- <div><a href="login.aspx" class="nav-item nav-link">Login</a></div>--%>
                    ...
                    <div><a href="servicee.aspx" class="nav-item nav-link ">Our services</a></div>
                     ...
                     <div><a href="aservice.aspx" class="nav-item nav-link ">Serviceorder</a></div>
    ...
    <div class="container-fluid pt-5">
        <div class="d-flex flex-column text-center mb-5 pt-5">
         <%--   <h4 class="text-secondary mb-3">Login Page</h4>--%>
            <h2 class="display-4 m-0">Registration Data! <span class="textAny Query"></span></h2>
        </div>
         <div class="row justify-content-center">
            <div class="col-12 col-sm-8 mb-5">
                <div class="contact-form">
                 ...
                 <br /><br />
                    <center>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderColor="#FF9900" BorderWidth="8px" Width="729px">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="hh1">
                                    <ItemTemplate>
                                        <asp:Label ID="Label6" runat="server" Text='<%# Eval("hh1") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="hh2">
                                    <ItemTemplate>
                                        <asp:Label ID="Label7" runat="server" Text='<%# Eval("hh2") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="hh3">
                                    <ItemTemplate>
                                        <asp:Label ID="Label8" runat="server" Text='<%# Eval("hh3") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
