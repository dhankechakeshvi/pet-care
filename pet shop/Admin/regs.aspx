<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="regs.aspx.cs" Inherits="pet_shop.Admin.regs" %>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="d-flex flex-column text-center mb-5 pt-5">
         <%--   <h4 class="text-secondary mb-3">Register Page</h4>--%>
            <h1 class="display-4 m-0">Register page <span class="textAny Query"></span></h1>
        </div>
                ...
                <div class="contact-form">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            ...
                            <asp:TextBox ID="fname" runat="server" class="form-control p-4"   ></asp:TextBox>
                     ...
                     <div class="control-group">
                        ...
                        <br />
                      <div class="control-group">
                          <asp:Label ID="Label6" runat="server" Text="Enter Mo."></asp:Label>
                        ...
                        <div>
                           <%-- <button class="btn btn-primary py-3 px-5" type="submit" id="sendMessageButton">Send Messagend Message</button>--%>
                            <asp:Button ID="Button1" class="btn btn-primary py-3 px-5" runat="server" Text="Register" OnClick="Button1_Click" />
                            <br />
                            <br />
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" Width="1026px" BorderColor="#FF9900" BorderWidth="8px">
                                <Columns>
