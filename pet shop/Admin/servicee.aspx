<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="servicee.aspx.cs" Inherits="pet_shop.Admin.servicee" %>
    ...
    <div class="container-fluid pt-5">
        <div class="d-flex flex-column text-center mb-5 pt-5">
         <%--   <h4 class="text-secondary mb-3">Register Page</h4>--%>
            <h1 class="display-4 m-0">Our Services<span class="textAny Query"></span></h1>
        </div>
            ...
            <div class="col-12 col-sm-8 mb-5">
                <div class="contact-form">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate">
                        ...
                        <br />
                         <div class="control-group">
                             <asp:Label ID="Label3" runat="server" Text="Pet Type (Dog/Cat)"></asp:Label>
                             <asp:TextBox ID="type" runat="server" class="form-control p-4"></asp:TextBox>
                           
                        </div>
                        <br />
                    
                        <div>
                            <asp:Label ID="Label16" runat="server" Text="Services"></asp:Label>
    <div class="form-control p-4" style="height: auto; max-height: 120px; overflow-y: auto;">
        <asp:CheckBoxList ID="chkservice" runat="server" RepeatDirection="Vertical" CssClass="checkbox-list">
            <asp:ListItem>PetTraining</asp:ListItem>
<asp:ListItem>PetDaycare</asp:ListItem>
<asp:ListItem>VeterinaryCheckups</asp:ListItem>
<asp:ListItem>PetWalking</asp:ListItem>
<asp:ListItem>PetPhotography</asp:ListItem>
        </asp:CheckBoxList>
                        </div>
                        <br />
                            <div class="control-group">
        <asp:Label ID="Label5" runat="server" Text="Date of Service"></asp:Label>
        <asp:TextBox ID="dos" runat="server" TextMode="Date" class="form-control p-4"></asp:TextBox>
                              
    </div>
    <br />
                   <div class="control-group">
        <asp:Label ID="Label6" runat="server" Text="Additional Service Requests"></asp:Label>
        <asp:TextBox ID="add" runat="server" TextMode="MultiLine" class="form-control p-4" Rows="3"></asp:TextBox>
    </div>
    <br />
                        <div>
                           ...
                           <%-- <asp:Button ID="Btn" class="btn btn-primary py-3 px-5" runat="server" Text="Done" />--%>
                        </div>
