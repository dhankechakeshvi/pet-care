<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="employee.aspx.cs" Inherits="pet_shop.Admin.employee" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="container-fluid pt-5">
        <div class="d-flex flex-column text-center mb-5 pt-5">
         <%--   <h4 class="text-secondary mb-3">Register Page</h4>--%>
            <h1 class="display-4 m-0">Employee Details <span class="textAny Query"></span></h1>
        </div>
                ...
                <div class="contact-form">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            ...
                            <asp:TextBox ID="id" runat="server" class="form-control p-4"   ></asp:TextBox>
                        ...
                        <br />
                        <div class="control-group">
                             <asp:Label ID="Label2" runat="server" Text="Employee Gender"></asp:Label>
                     ...
                     <div class="control-group">
                         ...
                         <asp:TextBox ID="depart" runat="server" class="form-control p-4"></asp:TextBox>
                        </div>
                        <br />
                     ...
                     <div class="control-group">
                      ...
                      <div class="control-group">
                          ...
                          <asp:TextBox ID="phone" runat="server" class="form-control p-4"></asp:TextBox>
    ...
    <div class="form-control p-4" style="height: auto; max-height: 120px; overflow-y: auto;">
        <asp:CheckBoxList ID="chkrole" runat="server" RepeatDirection="Vertical" CssClass="checkbox-list">
            <asp:ListItem>Doctor</asp:ListItem>
            <asp:ListItem>Founder & CEO</asp:ListItem>
            <asp:ListItem>Chef Executive</asp:ListItem>
             <asp:ListItem>Trainer</asp:ListItem>
        </asp:CheckBoxList>
                        </div>
                        <br />
                  <div>
                      <asp:Label ID="Label7" runat="server" Text="Employee Photograph"></asp:Label>
                      <br />
                      <asp:FileUpload ID="fldimg" class="form-control p-1" runat="server" />
                  </div>
                            <br />
                        <div>
                           <%-- <button class="btn btn-primary py-3 px-5" type="submit" id="sendMessageButton">Send Messagend Message</button>--%>
                            <asp:Button ID="btn" class="btn btn-primary py-3 px-5" runat="server" Text="Submit" OnClick="btn_Click" />
                            <br />
                            <br />
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" Width="1050px" BorderColor="#FF9900" BorderWidth="8px">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Emp_id">
                                        <ItemTemplate>
                                            <asp:Label ID="Label18" runat="server" Text='<%# Eval("Emp_id") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Emp_name">
                                        <ItemTemplate>
                                            <asp:Label ID="Label19" runat="server" Text='<%# Eval("Emp_name") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Gender">
                                        <ItemTemplate>
                                            <asp:Label ID="Label20" runat="server" Text='<%# Eval("Gender") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Email">
                                        <ItemTemplate>
                                            <asp:Label ID="Label22" runat="server" Text='<%# Eval("Email") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Mobile_no">
                                        <ItemTemplate>
                                            <asp:Label ID="Label23" runat="server" Text='<%# Eval("Mobile_no") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Role1">
                                        <ItemTemplate>
                                            <asp:Label ID="Label24" runat="server" Text='<%# Eval("Role1") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Role2">
                                        <ItemTemplate>
                                            <asp:Label ID="Label25" runat="server" Text='<%# Eval("Role2") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Role3">
                                        <ItemTemplate>
                                            <asp:Label ID="Label26" runat="server" Text='<%# Eval("Role3") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Role4">
                                        <ItemTemplate>
                                            <asp:Label ID="Label27" runat="server" Text='<%# Eval("Role4") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Image">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="ImageButton1" runat="server" Height="25" ImageUrl='<%# Eval("Image") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
