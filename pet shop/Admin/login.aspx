    <%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="pet_shop.Admin.login" %>
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                   ...
                   <%-- <div><a href="login.aspx" class="nav-item nav-link">Login</a></div>
                    ...
                    <div><a href="services.aspx" class="nav-item nav-link ">Our services</a></div>
    ...
    <div class="container-fluid pt-5">
        <div class="d-flex flex-column text-center mb-5 pt-5">
           <h4 class="text-secondary mb-3">Login Page</h4>
            <h2 class="display-4 m-0">Login page <span class="textAny Query"></span></h2>
        </div>
                ...
                <div class="contact-form">
                   ...
                   <%-- <form name="sentMessage" id="contactForm" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            ...
                            <asp:TextBox ID="TextBox1" runat="server" class="form-control p-4"   ></asp:TextBox>
                        ...
                        <div class="control-group">
                            ...
                            <asp:TextBox ID="TextBox2" runat="server" class="form-control p-4" ></asp:TextBox>
                    ...
                    <br />
                        ...
                        <div>
                            ...
                            <asp:Button ID="Button1" class="btn btn-primary py-3 px-5" runat="server" Text="Login" />
                        </div>
                        <br />
                 
                        <div>
                            <asp:LinkButton ID="LinkButton1" href="regs.aspx" runat="server">Register</asp:LinkButton>
                        </div>
                            
                    </form>--%>

                 <form name="sentMessage" id="contactForm" novalidate="novalidate" style="background-image: url('dog.jpg'); background-size: cover; background-position: center;"">
    <table class="table table-borderless">
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Text="User Name"></asp:Label>
                   <asp:TextBox ID="lname" runat="server" class="form-control p-4"></asp:TextBox>
            </td>
        ...
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" Text="Password"></asp:Label>
                  <asp:TextBox ID="lpass" runat="server" class="form-control p-4" TextMode="Password"></asp:TextBox>
            </td>
        ...
        <tr>
            <td colspan="2" class="text-center">
                <asp:Button ID="Button1" class="btn btn-primary py-3 px-5" runat="server" Text="Login" OnClick="Button1_Click" />
            </td>
        </tr>
        <tr>
            <td colspan="2" class="text-center">
